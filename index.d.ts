...
export namespace marked {
	...
	type TokenizerObject = Partial<
		Omit<Tokenizer<false>, "constructor" | "options">
	>;
	...
	class Renderer<T = never> {
		...
		html(this: Renderer | RendererThis, html: string): Promise<string | T>;
		heading(
			this: Renderer | RendererThis,
			text: string,
			level: 1 | 2 | 3 | 4 | 5 | 6,
		...
		hr(this: Renderer | RendererThis): Promise<string | T>;
		list(
			this: Renderer | RendererThis,
			body: string,
			ordered: boolean,
		...
		em(this: Renderer | RendererThis, text: string): Promise<string | T>;
		codespan(
			this: Renderer | RendererThis,
			code: string
		): Promise<string | T>;
		br(this: Renderer | RendererThis): Promise<string | T>;
		del(this: Renderer | RendererThis, text: string): Promise<string | T>;
		link(
			this: Renderer | RendererThis,
			href: string | null,
			title: string | null,
		...
		text(this: Renderer | RendererThis, text: string): Promise<string | T>;
	}

	type RendererObject = Partial<
		Omit<Renderer<false>, "constructor" | "options">
	>;
	...
	class Parser {
		...
		parse(src: Token[] | TokensList): Promise<string>;
		parseInline(src: Token[], renderer: Renderer): Promise<string>;
		next(): Token;
	}
